...
# = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = =
# FIXME: Q&D fix to call 'run_fpga_flow.py' with the right path
task_script_dir = os.path.abspath(os.path.join(os.environ['OPENFPGA_PATH'],"openfpga_flow","scripts"))
...
def generate_each_task_actions(taskname):
    ...
    for bech_name, each_benchmark in task_conf["BENCHMARKS"].items():
        ...
        yosys_params = [
            ...
            "yosys_args",
            "yosys_abc_command",    # FIXME: add the ${YOSYS_ABC_COMMAND} option
            "yosys_lut_max_width",  # FIXME: add the ${YOSYS_LUT_MAX_WIDTH} option
